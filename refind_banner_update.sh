...
list_absolute_path()
{
	...
	echo -e "${DARK_RED}--------------------------------------------------------------${NC}"  # Separate message
	echo -e "\n${RED}This script requires root privileges for this operation.${NC}"
	echo -e "${NC}Attempting to run with sudo..."
...
#--------------------------------------------------------------
# The BEGIN of <Manual> Function Define
#--------------------------------------------------------------
...
#--------------------------------------------------------------
# The END of <Manual> Function Define
#--------------------------------------------------------------
...
while [[ "$#" -gt 0 ]]; do
	case "$1" in
		...
		-c|--config)
			echo -e "${DARK_RED}--------------------------------------------------------------${NC}"  # Separate message
			echo -e "${RED}This script requires root privileges for this operation.${NC}"
			echo -e "${NC}Attempting to run with sudo..."
			display_current_banner
			exit 0
			;;
