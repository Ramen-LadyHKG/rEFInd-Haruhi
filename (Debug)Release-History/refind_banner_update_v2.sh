...
check_root() {
  if [ "$(id -u)" != "0" ]; then
    echo "This script requires root privileges for this operation."
...
while [[ "$#" -gt 0 ]]; do
  case "$1" in
    ...
    -c|--config)
      ...
      exit 0
      ;;
    -h|--help|--help-english|--help-japanese|--help-cantonese|--help-traditional-chinese)
      display_help "$1"
      ;;
    *)
